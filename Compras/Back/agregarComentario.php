...
$query = "UPDATE compras_lineasabiertas SET Status_Comentario = '$comentario', Fecha_Llegada = '$fecha_recibimiento' WHERE Id = $id_compra";
...
header("Location: ../detallesCompra.php?id=$id_compra");
?>
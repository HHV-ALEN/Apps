...
$query = "UPDATE compras_cargacompras SET Status_Comentario = '$comentario', Fecha_Llegada = '$fecha_recibimiento' WHERE Id = $id_compra";
...
header("Location: ../detallesCompraPestañas.php?id=$id_compra");
?>
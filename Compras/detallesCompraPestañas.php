...
$query = "SELECT * FROM compras_cargacompras WHERE Id = $id";
        ...
        <div class="card border-0 shadow-lg">
            ...
            <div class="card-header bg-gradient-primary text-white py-3">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="bi bi-box-seam me-2"></i>Detalles de la Compra #<?= htmlspecialchars($datos['Id']) ?>
                    </h5>
            ...
            <div class="card-body p-4">
                ...
                <div class="row mb-4">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            ?>
                                <form action="Back/agregarComentarioPestañas.php" method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="detail-item">
                                ...
                                <div>
                                    ...
                                    <span class="detail-value"><?= htmlspecialchars($datos['OrdenCompra']) ?></span>
                                </div>
                            </div>
                            <div class="detail-item">
                                <i class="bi bi-file-earmark-text text-primary"></i>
                                <div>
                                    ...
                                    <span class="detail-value"><?php
                                                                if (htmlspecialchars($datos['OrdenVenta']) == '') {
                                                                    echo "Sin Asignar";
                                                                } else {
                                                                    echo $datos['OrdenVenta'];
                                                                }
                                                                ?></span>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="detail-item">
                                ...
                                <div>
                                    ...
                                    <span class="detail-value"><?= date('d/m/Y H:i', strtotime($datos['FechaRegistro'])) ?></span>
                                </div>
                            </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="detail-item">
                                ...
                                <div>
                                    <span class="detail-label">Código Item</span>
                                    <span class="detail-value"><?= htmlspecialchars($datos['CodItem']) ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <div class="detail-item">
                                ...
                                <div>
                                    <span class="detail-label">Importe Pendiente</span>
                                    <span class="detail-value">$<?= number_format($datos['ImportePendiente'], 2) ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="detail-item">
                                ...
                                <div>
                                    ...
                                    <span class="detail-value"><?= $datos['Moneda'] ? htmlspecialchars($datos['Moneda']) : '<span class="text-muted">No especificada</span>' ?></span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="d-flex justify-content-center mt-5 gap-3">
                    <a href="listado.php" class="btn btn-outline-primary px-4 rounded-pill">
